...
public class Algorithm{
    ...
    static String DiagnosedDisease = "";
    static String[] tempsArray = {}, res = {};


    static void readTxt() throws FileNotFoundException  {
        String token1 = "";
        // create Scanner inFile1
        File text = new File("src/main/java/org/example/sample.txt");
        Scanner inFile1 = new Scanner(new File("src/main/java/org/example/sample.txt"));
